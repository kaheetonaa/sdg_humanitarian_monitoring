...
if code:
    match platform:
        case 'HOT-TM':
            data=requests.get('https://tasking-manager-production-api.hotosm.org/api/v2/projects/'+code+'/',headers={"accept":"application/json","Authorization":"TVRBek5ERTVPRGsuYUFkTlZnLkFZU3NCNnpyV3ZFeG5QdnIzOWo1WTJnYlRqdw=="})#.json()
            st.write(data)
